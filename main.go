...
func respond(conn net.Conn, response HttpResponse) error {
...
func readHTTPRequest(r *bufio.Reader) (HTTPRequest, error) {
	...
	if err != nil {
		return HTTPRequest{Method: "", URL: ""}, err
	}
	...
	if parts[0] == "GET" || !hasContentLength {
		return HTTPRequest{Method: parts[0], URL: parts[1], Headers: headers}, nil
	}
	...
	return HTTPRequest{Method: parts[0], URL: parts[1], Headers: headers, Body: string(body)}, nil
}
